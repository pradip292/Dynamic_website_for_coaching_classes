...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top position-relative">  <!--  postion relative to align the tab content  -->
  ...
  <a class="nav-link text-white" href="../manage_videos/manage_videos.php">Back <span class="sr-only">(current)</span></a>
...
<div class="container-fluid" style="margin-top: 5px;" >
  ...
  <!-- ========================================================================================================================== -->
        ...
        <div>
        <h3 class="text-center mt-2">Manage your <?php  echo $_GET['course_name']; ?> videos</h3>
