...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="#">Admin Section (Video)</a>
  <button type="btn btn-outline-success" class="btn btn-primary float-right" style="height: 40px; margin-left:1180px;"><a href="../..//login.php" class="text-white ">Logout</a> </button>
      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="../admin_main.php">Back</a></li>
...
<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><center><b>YOUR VIDEOS COURSE</b></center></div><br>
<div class="row">
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        Video course added successfully
				      </div>
				...
				<div class="modal fade" id="myModal">
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <!-- Modal body -->
				      <div class="modal-body">
				        	Video course deleted successfully
				      </div>
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2 "><h3>UPDATE VIDEO COURSE</h3></div>
				 ...
				 <form action="video_add.php" method="post" enctype="multipart/form-data" onsubmit="">
				 	 ...
				 	 <div class="form-group">
					    ...
					    <label for="exampleFormControlSelect1">Select video Course:</label>
					    ...
					    <div class="form-group">
					      <label for="pwd">Course Description (Required):</label>
					      <input type="text" class="form-control" id="c_desc" placeholder="Enter Course Description" name="course_desc">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>

					     <div class="form-group">
					      <label for="pwd">Course Image (Required):</label>
					      <input type="file" class="form-control" id="c_img" placeholder="Enter Course Image" name="course_image">
					      <span id="image_error" class="text-danger font-weight-bold"></span>
					    </div>
          ...
          <div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2"><h3>DELETE VIDEO COURSE</h3></div>
