...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="#">Admin Section (Courses)</a>
  <button type="btn btn-outline-success" class="btn btn-primary float-right" style="height: 40px; margin-left:1165px;"><a href="../..//login.php" class="text-white ">Logout</a> </button>
...
<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b><center>YOUR COURSES</center></b></div><br>
<div class="row">
