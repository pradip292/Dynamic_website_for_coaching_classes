...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="#">Admin Section (Quiz)</a>
  <button type="btn btn-outline-success" class="btn btn-primary float-right" style="height: 40px; margin-left:1190px;"><a href="../..//login.php" class="text-white ">Logout</a> </button>
...
<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1 text-center" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b class="text-center">YOUR ONLINE QUIZES</b></div><br>
<div class="row justify-content-center">

<div class="col-md-4">
 <center><label>Select Quiz</label><br>
    <form method="POST" action="../../online_quize/question_show_admin.php">
...
<!-- ============================================================================================================ -->
	...
	if ( isset($_GET['run']) and $_GET['run']=="success")      //first if condition for course added
	{
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <select class="form-control" id="exampleFormControlSelect1"  name="cat">
                <option  class="active">choose subject</option>
                <?php 
